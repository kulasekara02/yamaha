        ...
        <div id="mainframe">
            <div class="headingspacefullpage" style="width:100%">
              ...
              ?>
                        ...
                        <tr>
                            <td width="5%"><?php echo $tracking_data['TrackID'];?> <input name="selectedvalues[]"
                                    type="hidden" value="<?php echo $tracking_data['TrackID'];?>"></td>
                            ...
                            <td width="20%">
                                <select name="newstatus[]" onChange="AutoClickUpdate()">
                                    <option selected="selected" style="color:#09F">
                                        <?php echo  $tracking_data['Status']; ?></option>
