	                ...
	                <form method="post">
	                    ...
	                    <div class="col_3">
	                        ...
	                        <table>
	                            ...
	                            <tr>
	                                <td><b>Total Price:</b> <?php echo $_SESSION['totalprice']; ?>.00 LKR <sub>*Excluding
	                                        Shipping Charges</sub></td>
	                        ...
	                        <table>
	                            <tr>
	                                <td></td>
	                                <td colspan="6" class="tf"><input type="submit" name="placeorder" class="cart_btn"
