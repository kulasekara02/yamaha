                ...
                <h3Contact Us</h3>
                    ...
                    <div class="row">
                        <div class="col_3">
                            ...
                            <div class="container">
                                ...
                                <form name="ContactForm" method="post">
                                    ...
                                    <br>
                                    <br>
                                    <textarea name="txtaMessage" id="txtaMessage" placeholder="Your Message...."
                                        required minlength="100" maxlength="800"></textarea>
                                    <br>
                                    <br>
                                    <p><input name="Send Message" type="submit" id="Send Message" value="Send Message"
                        ...
                        <div class="col_3">
                            ...
                            <img src="Resources/designimages/Service_Center.jpg" alt="Colombo Store "
