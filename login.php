	            ...
	            <div class="sub_framefullpage">
	                ...
	                <div class="row">
	                    <div class="col_3">
	                        <h3>New Customers</h3>
	                        <form method="post">
	                            <p>If you create an account with us, you will get additional benefits such as order
	                                history, prioritised delivery and much more.</p>
	                            <input name="NewAccount" type="button" value="Create a New Account"
	                                onclick="document.location = 'register.php'">
	                        </form>
	                        <?php
	...
	?>
	                        ...
	                        <form method="post">
	                            ...
	                            <input name="deliveryidguest" type="hidden"
	                                value="<?php echo $result_delivery_id['delivery_id']; ?>" readonly>
	                        </form>
	                        <?php
	}
    ?>
