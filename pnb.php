    ...
    <div id="wrapper">
                    ...
                    <ul>
                        <form action="" method="post">
                           ...
                           //Count number of rows
                           	...
                           	{
                           ?>
                            <li><input id="<?php echo $category['CategoryName']; ?>" type="submit"
                                    name="categoryvalues[]" value="<?php echo $category['CategoryName']; ?>"
                                    class="category_btn"></li>
                            <?php } } else {?>
        ...
        <div id="mainframe">
            ...
            //Count number of rows
            	...
            	{
            ?>
                    <option value="<?php echo $bike_data['ProductBikeType']; ?>">
                        <?php echo $bike_data['ProductBikeType']; ?></option>
                    <?php } } else {?>
                    <h3>Oops! No Bikes!</h3>
                    <?php } ?>
                </select>
            ...
            ?>
                    ...
                    <div class="product">
                        ...
                        <?php } else  {?> <span class="product-discount-label"
                            style="background-color:#FFF; color:#FFF">-<?php echo  $data['ProductDiscountAmount'];?>
                            %</span>
                        <?php } ?>
                        ...
                        <a href="viewproduct.php?pid=<?php echo $data['ProductID']; ?>"><input name="" type="button"
                                value="See Details"></a>
                        </form>
                    </div>
                    <?php } } else {?>
