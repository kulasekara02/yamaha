            ...
            <div class="sub_framefullpage">
                ...
                <div class="row">
                    <div class="col_3">
                        ...
                        <p>If you create an account with us, you will get additional benefits such as order history,
                            prioritised delivery and much more.</p>
                    </div>
                    <div class="col_3">
                        ...
                        <form method="POST">
                            ...
                            <p>
                                <input type="button" value="Forgot Password" class="cart_btn"
                                    onclick="location.href='forgotpassword.php'">
                            </p>
                            <?php } ?>
                        </form>
                    </div>
